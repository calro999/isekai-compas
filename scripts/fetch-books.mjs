...
async function writeCategoryPages(books, tagEntries, authorEntries, seriesEntries) {
  ...
  // 10. index.html を JavaScript非依存の100%完全静的Pure HTMLとして生成
  const indexHtmlContent = `<!doctype html><html lang="ja"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>異世界コンパス｜異世界漫画・ラノベを原点1巻から比較・全巻探せる専門メディア</title><meta name="description" content="全${books.length}作品の異世界漫画・ライトノベルを1巻あらすじ、見どころ、全巻表紙コレクション棚、作品比較で探せる専門ナビゲーションメディア。"><link rel="icon" href="/favicon.svg" type="image/svg+xml"><link rel="canonical" href="${siteUrl}/"><style>${commonStyle}.hero-box{background:#fff;border:1px solid #d6a24a;border-radius:12px;padding:36px 24px;text-align:center;margin:24px 0;box-shadow:0 6px 16px rgba(0,0,0,0.04)}.feature-hub-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:16px;margin:20px 0}.feature-hub-card{background:#fff;border:1px solid #e1e6de;border-radius:8px;padding:16px;display:flex;flex-direction:column;gap:8px;transition:transform 0.2s}.feature-hub-card:hover{transform:translateY(-3px);border-color:#d6a24a}</style></head><body>${renderHeader('/')}<main><section class="hero-box"><span class="eyebrow" style="color:#d6a24a;">ISEKAI COMIC & NOVEL COMPASS</span><h1 style="font-family:serif;font-size:32px;margin:12px 0 16px;">次に読む異世界を、原点1巻から選ぼう。</h1><p style="color:#5f6c62;font-size:15px;line-height:1.8;max-width:720px;margin:0 auto 24px;">全${books.length}作品の第1巻あらすじ、3大見どころ、全巻・外伝表紙コレクション、作品同士の1500字比較解説を完全網羅！</p><div style="display:flex;justify-content:center;gap:12px;flex-wrap:wrap;"><a class="card-btn" style="padding:10px 20px;font-size:14px;" href="/features/">【注目】テーマ別おすすめ7選を見る ↗</a><a class="card-btn" style="padding:10px 20px;font-size:14px;background:#d6a24a;color:#17221f;" href="/compare/">作品比較ナビを見る ↗</a></div></section><h2>🎯 気分・テーマで選ぶ厳選特集ハブ</h2><div class="feature-hub-grid"><a class="feature-hub-card" href="/features/musou/" style="text-decoration:none;"><strong style="color:#17221f;font-size:16px;">【圧倒的無双・爽快感】おすすめ7選</strong><span style="font-size:13px;color:#5f6c62;">チート能力や規格外の実力で敵をなぎ倒す無双系名作</span></a><a class="feature-hub-card" href="/features/slowlife/" style="text-decoration:none;"><strong style="color:#17221f;font-size:16px;">【癒やし・スローライフ】おすすめ5選</strong><span style="font-size:13px;color:#5f6c62;">絶品異世界飯やのんびり日常を楽しむ心温まる名作</span></a><a class="feature-hub-card" href="/features/brain/" style="text-decoration:none;"><strong style="color:#17221f;font-size:16px;">【頭脳戦・重厚世界観】おすすめ6選</strong><span style="font-size:13px;color:#5f6c62;">伏線回収や国家間の駆け引きが熱い本格ファンタジー</span></a><a class="feature-hub-card" href="/features/climb/" style="text-decoration:none;"><strong style="color:#17221f;font-size:16px;">【底辺からの下剋上】おすすめ6選</strong><span style="font-size:13px;color:#5f6c62;">最弱や裏切りから這い上がるドラマチックな逆転劇</span></a></div><h2>🔥 全掲載作品カタログ（全${books.length}作品）</h2><div class="book-cards-grid">${books.map(renderBookCard).join('')}</div></main>${renderFooter()}</body></html>`
  await fs.writeFile(path.join(root, 'index.html'), indexHtmlContent)
  await fs.writeFile(path.join(root, 'public', 'index.html'), indexHtmlContent)

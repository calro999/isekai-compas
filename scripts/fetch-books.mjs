...
async function writeWorkPage(book, books) {
  ...
  const title = `${book.title}｜作品紹介・読者タイプ・見どころ｜異世界コンパス`
...
async function writeComparePages(books, pairs) {
  ...
  const indexHtml = `<!doctype html><html lang="ja"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>異世界作品の比較・関連作品一覧｜異世界コンパス</title><meta name="description" content="異世界作品をタグ、世界観、読者タイプ、読みやすさから比較。"><link rel="canonical" href="${siteUrl}/compare/"><link rel="icon" href="/favicon.svg" type="image/svg+xml"><style>${commonStyle}</style></head><body>${renderHeader('/compare/')}<main><div class="crumb"><a href="/">トップ</a>　/　比較一覧</div><div class="eyebrow">WORK COMPARISON</div><h1>異世界作品の比較・関連作品</h1><p class="lead">似ている異世界作品の要素・ジャンル・タグ・読者タイプを並べて徹底比較できます。</p><div class="category-grid">${links}</div></main>${renderFooter()}</body></html>`

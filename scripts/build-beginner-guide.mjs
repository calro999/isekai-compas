...
<main>
  ...
  <section class="section-block" id="section-points">
    ...
    <ul style="padding-left: 20px; line-height: 1.9; font-size: 15px; color: #2c3a32;">
      ...
      <li><strong>楽天カード決済でポイントがさらに貯まる：</strong> 楽天Koboでのお買い物を楽天カードで支払うと、普段の還元に加えてポイントが効率よく貯まり、貯まったポイントで次の巻や新刊を実質無料で買い足していく好循環が作れます。</li>
      <li><strong>定期的なまとめ買いクーポン：</strong> 「まとめ買いで15%〜20%OFF」「初めての方限定の割引クーポン」など、頻繁に割引キャンペーンが実施されています。</li>
    </ul>

    <div style="background:#f8f9f7; border:1px dashed #c9d8c6; border-radius:8px; padding:18px 20px; margin-top:24px; text-align:center;">
      <p style="font-size:13.5px; color:#3e5245; margin:0 0 10px; line-height:1.7;">
        💳 <strong>【お得情報】</strong> 楽天カードをお持ちでない方は、新規入会＆3回以上のご利用で<strong>5,000ポイント</strong>が進呈されるキャンペーン中！<br>
        <span style="font-size:12px; color:#607367;">※もらったポイントはそのまま楽天Koboでの単行本購入やまとめ買いにも活用できます。</span>
      </p>

...
<main>
  ...
  <div style="background:#f8f9f7; border:1px dashed #c9d8c6; border-radius:8px; padding:16px 20px; margin:30px 0; font-size:13px; color:#3e5245; line-height:1.7; text-align:center;">
    <p style="margin:0 0 8px;">💳 <strong>【読書メモ・お得情報】</strong> 原作小説やコミカライズの全巻まとめ買いは、楽天カード決済を活用すると普段のお買い物に加えてポイントが効率よく貯まります。新規入会＆3回以上利用で<strong>5,000ポイント</strong>がもらえるキャンペーンも実施されています。</p>
